  ...
  const teachers: Teacher[] = [
    {
      ...
      email: 'ana.robles@unc.edu.pe',
      courses: ['Algoritmos y Estructura de Datos', 'Diseño de Compiladores'],
    },
    {
      id: 't002',
      name: 'Lic. Carlos M. Vega',
      department: 'Matemática',
      email: 'carlos.vega@unc.edu.pe',
      courses: ['Matemática Discreta', 'Cálculo Diferencial'],
    },
    {
      id: 't003',
      name: 'Ing. Laura F. Quispe',
      department: 'Ingeniería de Software',
      email: 'laura.quispe@unc.edu.pe',
      courses: ['Programación Orientada a Objetos', 'Ingeniería de Requisitos'],
    },
    {
      id: 't004',
      name: 'Mg. Roberto P. Torres',
      department: 'Sistemas de Información',
      email: 'roberto.torres@unc.edu.pe',
      courses: ['Bases de Datos I', 'Sistemas Distribuidos'],
    },
  ];
