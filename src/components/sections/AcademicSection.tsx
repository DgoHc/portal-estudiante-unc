    ...
    <div id="notas" className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-lg">Grado {student?.grade} • {totalCredits} asignaturas</p>
            </div>
          </div>
      ...
      <div className="p-8">
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-bold text-gray-900 mb-6">Asignaturas del Año</h3>
          {courses.map((course) => (
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">{course.code} • {course.professor} • {course.credits} asignaturas</p>
                  </div>
                </div>
                <div className="text-right">
